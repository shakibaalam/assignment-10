...
const Services = () => {
    return (
        <div id='services' className='container my-5 py-5 '>
            <h2 className='service-heading text-center fw-bold'>Top attractions Places ....</h2>
            <div className='row my-5 py-5'>
                <div className='col-12 col-md-6'>
                    <h3 className='service-heading fw-bold'>Private Tour: 5 Days - Bangladesh Nature & Culture Tour - North-eastern part</h3>
                    ...
                    <h3 className='fw-bold'>Price: $666.67</h3>
                    <button className=' btn fw-bold fs-5 btn-style px-4 my-3'> <CustomLink to='/checkout'>Check Availability <IoMdArrowDroprightCircle></IoMdArrowDroprightCircle></CustomLink></button>
                </div>
            ...
            <div className='row my-5 py-5'>
                ...
                <div className='col-12 col-md-6'>
                    <h3 className='service-heading fw-bold'>6 Days Ancient North Bengal Tour</h3>
                    ...
                    <h3 className='fw-bold'>Price: $800</h3>
                    <button className='btn fw-bold fs-5 btn-style px-4 mt-3'><CustomLink to='/checkout'>Check Availability <IoMdArrowDroprightCircle></IoMdArrowDroprightCircle></CustomLink></button>
                </div>
            </div>

            <div className='row mt-5 pt-4'>
                <div className='col-12 col-md-6'>
                    <h3 className='service-heading fw-bold'>Dhaka City Tour</h3>
                    ...
                    <h3 className='fw-bold'>Price: $90</h3>
                    <button className='btn fw-bold fs-5 btn-style px-4 my-4'><CustomLink to='/checkout'>Check Availability <IoMdArrowDroprightCircle></IoMdArrowDroprightCircle></CustomLink></button>
                </div>
                <div className='col-12 col-md-6 text-center'>
